...
MODEL_CONFIG=mask_rcnn_resnet101_atrous_coco.config
...
GCS_IMAGES_DIR=
REGION=us-central1
IMAGES_ZIP=mask-images-for-training.zip
ANNOTATIONS_ZIP=mask-annotations.zip
MASKS_ZIP=image-masks.zip
